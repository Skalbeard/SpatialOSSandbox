...
void APortalManager::SetControllerOwner(AMyPlayerController* NewOwner)
{
    GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Red, "SetControllerOwner");
    ...
    Character = Cast<AMyCharacter>(NewOwner->GetCharacter());
}
...
void APortalManager::UpdateCapture(APortal* Portal)
{
        ...
        && Character != nullptr)
    {
        ...
        Character->GetComponents<UCameraComponent>(CameraComps);
        UCameraComponent* PlayerCamera = CameraComps[0];
...
void APortalManager::RequestTeleportByPortal(APortal* Portal, AActor* TargetToTeleport)
{
    ...
    {
        GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Red, "RequestTeleportByPortal");
    ...
    {
        GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Red, "NULLS IN RequestTeleportByPortal");
    }
}